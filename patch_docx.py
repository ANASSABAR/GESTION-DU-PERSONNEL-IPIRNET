...
t_hs = doc.tables[4]
# It has: id_heure_sup, date, nombre_heures, motif, id_personnel
# Keep: id_heure_sup, date, nombre_heures, contrat, prix_heure, motif, id_personnel
# Best way: rewrite the table
data_hs = [
...
# Ajouter règles métier sous la table HEURE_SUPPLEMENTAIRE
# Actually, the user asked to add "Ajouter règles métier : CDI = 25 DH/h ... " under HEURE_SUPPLEMENTAIRE
...
doc.add_heading('Contraintes métier', level=2)
doc.add_paragraph("Contrat ∈ {CDI, CDD, STAGE, INTERIM}", style='List Bullet')
doc.add_paragraph("Motif ∈ {Réunion pédagogique, Surveillance d’examen, Révision programme, Correction copies, Formation interne, Maintenance système, Support administratif, Travail exceptionnel, Urgence service, Projet spécial}", style='List Bullet')
